        ...
        <div className="max-w-5xl mx-auto">
            <div className="card h-[calc(100vh-16rem)] flex flex-col">
                ...
                <div className="flex items-center justify-between mb-4 pb-4 border-b border-[#2a2a3a]">
                    <div>
                        <h2 className="text-2xl font-bold">Chat with Your Documents</h2>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className="p-3 text-left bg-[#1a1a24] border border-[#2a2a3a] rounded-lg hover:border-indigo-500 transition-all text-sm"
                                        >
                                            {question}
                                        </button>
                                    ))}
                                                ...
                                                <div className="mt-3 pt-3 border-t border-[#2a2a3a]">
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        {message.citations.map((citation, citIdx) => (
                                                            ...
                                                            >
                                                                📄 {citation.document_name} (Section {citation.chunk_index})
                                                            </button>
                                                        ))}
                                                    </div>
                                                </div>
                    ...
                    >
                        ...
                        <div className="space-y-3">
                            <div>
                                ...
                                <p className="font-semibold">{selectedCitation.document_name}</p>
                            </div>

                            <div>
                                <p className="text-sm text-gray-400">Section</p>
                                <p className="font-semibold">Chunk {selectedCitation.chunk_index}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-semibold">{(selectedCitation.relevance_score * 100).toFixed(1)}%</span>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="p-4 bg-[#1a1a24] border border-[#2a2a3a] rounded-lg">
                                    <p className="text-sm">{selectedCitation.content_preview}</p>
                                </div>
                            </div>
                        </div>
                    </div>
